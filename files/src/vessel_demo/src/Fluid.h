...
public:
	...
	//void init();
	void draw(std::shared_ptr<MatrixStack> MV, const std::shared_ptr<Program> p, const std::shared_ptr<Shape> sphere, const std::shared_ptr<Shape> cell, const std::shared_ptr<Shape> heart) const;
